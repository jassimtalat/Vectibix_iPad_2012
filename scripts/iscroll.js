    ...
    iScroll.prototype = {
        ...
        touchMove: function(e) {
            ...
            if (newX > 0 ) {
                ...
                $('#myslide .cover').animate({ left: -26 * (parseInt(1) - 1) })  /*----- Width of div mystuff ------ */
                ...
                $('.graph3-100-50').cycle(0);
                $('.page5graph-1').cycle(0);
                $('.whiteareapage3-2').cycle(0);
                $('.whiteareapage3-1').cycle(0);
                $('.whiteareapage3-3').cycle(0);
                
                $("#r5l1").animate({ opacity: 0 });
                $("#r5l2").animate({ opacity: 0 });
                $("#r5s2").animate({ opacity: 0 });
                $("#r7l1").animate({ opacity: 1 });
                $("#r7l2").animate({ opacity: 0 });
                $("#r7l3").animate({ opacity: 0 });
                $("#r4l1").animate({ opacity: 0 });
                $("#r4l2").animate({ opacity: 0 });
                $("#r4l3").animate({ opacity: 0 });

                $("#r7l4").animate({ opacity: 0 });
                $("#r7s1").animate({ opacity: 0 });
                $("#r2").animate({ opacity: 0 });
                $("#ra2").animate({ opacity: 0 });
                $('.graph3-100-50').cycle(0);
                $('.page5graph-1').cycle(0);
                $('.whiteareapage3-2').cycle(0);
                $('.whiteareapage3-1').cycle(0);    
                $('.whiteareapage3-3').cycle(0);
                $('.whiteareapage4-1').cycle(0);
                $('.page6imagearea').cycle(0);
                $('.page6imagearea2').cycle(0);
                $('.whiteareapage4-2').cycle(0);
                $('.page7imagearea').cycle(0);
                $('.whiteareapage3-4').cycle(0);
            }
