...
;(function($){
    var Flip = function(canvas,width,height,images,opts) {
      //private vars
      opts = $.extend({background:"transparent",cornersTop:true,scale:"noresize"},opts);
      var obj = this,
      el = canvas.prev(),
      index = 0,
      init = false,
      ...
      gradientColors = opts.gradientColors || ['#006083','#006083','#008bbe'],
      ...
      var
        ...
        flipDuration=500,flipping = false,baseFlipX,baseFlipY,
        lastmX,lastmY,
        inCanvas = false,
        mousedown = false,
        dragging = false;
      ...
      cornerMove =  function() {
        ...
        mX = basemX+Math.sin(Math.PI*2*delta/2000);
        mY = basemY+Math.cos(Math.PI*2*delta/2000);
        drawing = true;
        window.setTimeout(draw,0);
      },
    ...
    $.fn.jFlip = function(width,height,opts){
      return this.each(function() {
        ...
        new Flip($(this).next(),width || 573,height || 113,images,opts);
      });
    };
